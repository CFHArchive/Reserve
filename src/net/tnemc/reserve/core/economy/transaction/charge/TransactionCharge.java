package net.tnemc.reserve.core.economy.transaction.charge;
...
public class TransactionCharge {
   ...
   * @param currency The {@link Currency} this {@link TransactionCharge} involves.
  ...
  public TransactionCharge(String world, Currency currency, BigDecimal amount, TransactionChargeType type) {
